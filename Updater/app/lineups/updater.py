...
class LineupsUpdater:
    ...
    def update_match_lineups(self, fixture_id: int, full_update=True):
    ...
    def _update_matches(self, matches_list, full_update=True):
        ...
        for match in matches_list:
            ...
            success = self.update_match_lineups(fixture_id, full_update)
            if success:
                updated_count += 1
    ...
    def update_lineups_by_matches(self, matches_list, league_id, season):
        """Update lineups for a list of matches"""
