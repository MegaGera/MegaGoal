...
class EventsUpdater:
    ...
    def update_match_events(self, fixture_id: int, full_update=True):
    ...
    def _update_matches(self, matches_list, full_update=True):
        ...
        for match in matches_list:
            ...
            success = self.update_match_events(fixture_id, full_update)
            if success:
                updated_count += 1
    ...
    def update_events_by_matches(self, matches_list, league_id, season):
        """Update events for a list of matches"""
