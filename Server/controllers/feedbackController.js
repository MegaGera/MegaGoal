...
import { buildUserFeedback, parseUserFeedbacks } from '../entities/userFeedbackEntity.js';

// Submit user feedback
export const submitFeedback = async (req, res) => {
  const db = getDB();
  try {
    const feedbackData = buildUserFeedback({
      body: req.body,
...
export const getAllFeedback = async (req, res) => {
  ...
  try {
    ...
    const validatedResult = parseUserFeedbacks(result);
