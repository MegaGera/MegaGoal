...
@Component({
  selector: 'app-admin',
  standalone: true,
  imports: [CommonModule, FormsModule, AdminLeaguesComponent, AdminMatchesComponent, AdminPlayersComponent, AdminFeedbackComponent],
  templateUrl: './admin.component.html',
  styleUrl: './admin.component.css'
})
export class AdminComponent {
  selectedAdminView: 'leagues' | 'matches' | 'players' | 'feedback' = 'leagues';
}